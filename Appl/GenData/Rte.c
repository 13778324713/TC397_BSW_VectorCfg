...
FUNC(void, RTE_CODE) SchM_Init(void)
{
  ...
  (void)SetRelAlarm(Rte_Al_TE2_OsTask_10ms_OsCore0_0_10ms, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(10)); /* PRQA S 3417 */ /* MD_Rte_Os */
...
{
  /* deactivate alarms */
  (void)CancelAlarm(Rte_Al_TE2_OsTask_10ms_OsCore0_0_10ms); /* PRQA S 3417 */ /* MD_Rte_Os */
 ...
 *********************************************************************************************************************/
TASK(OsTask_10ms__OsCore0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
